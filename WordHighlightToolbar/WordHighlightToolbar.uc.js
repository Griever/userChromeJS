...
window.gWHT.ToolbarClass.prototype = {
	...
	init: function(aTab) {
		...
		this.reloadbutton.setAttribute("tooltiptext", "ワードをハイライトし直す");
		...
		this.addbutton.setAttribute("tooltiptext", "ワードを追加");
		...
		switch(event.type){
			...
			case "command":
				...
				if (event.currentTarget == this.addbutton) {
					var word = prompt("強調したい文字を入力してください", gWHT.getBrowserSelection());
